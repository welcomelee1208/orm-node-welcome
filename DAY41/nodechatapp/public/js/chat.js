	...
	$("#contacts-tab").click(function(){
		...
		$.ajax({
			...
			success:function(result){
				console.log("모든 사용자정보 호출결과:",result)
				if(result.code == 200){
					
					//최초 ul채그내 li태그 모두 삭제 처리
					$(".contacts-list").html("");
					// contact 탭에서 사용자 표출
			...
			err:function(err){
				console.log("벡엔드 api호출 에러 발생:",err)
			}
		})
	});
	// 선택 사용자별 채팅방 입장 처리 함수
